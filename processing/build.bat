...
REM  -- -Z timings
wasm-pack build --target web --out-dir pkg-web -- --all-features
...
REM echo a|Xcopy /E /I .\pkg-no-modules\tko_processing_bg.wasm ..\frontend\public\ >nul 2>&1
REM Copy other files and append export
REM echo a|Xcopy /E /I .\pkg-no-modules\*.ts ..\frontend\processing\ >nul 2>&1
REM echo a|Xcopy /E /I .\pkg-no-modules\package.json ..\frontend\processing\ >nul 2>&1
REM echo export default wasm_bindgen;>>.\pkg-no-modules\tko_processing.js
REM echo a|Xcopy /E /I .\pkg-no-modules\*.js ..\frontend\processing\ >nul 2>&1
