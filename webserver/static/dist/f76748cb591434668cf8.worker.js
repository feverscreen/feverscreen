...
// UNUSED EXPORTS: processSensorData
...
/* harmony default export */ const cptv_player = (self.wasm_bindgen);
// EXTERNAL MODULE: ./node_modules/worker-loader/dist/cjs.js!./src/processing.ts
var processing = __webpack_require__(356);
var processing_default = /*#__PURE__*/__webpack_require__.n(processing);
;// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js??clonedRuleSet-40[0].rules[0].use[0]!./node_modules/thread-loader/dist/cjs.js!./node_modules/babel-loader/lib/index.js!./node_modules/ts-loader/index.js??clonedRuleSet-40[0].rules[0].use[3]!./src/frame-listener.ts
...
(async function run() {
  workerContext.addEventListener("message", async event => {
    ...
    if (message.useLiveCamera) {
      new CameraConnection(message.hostname, message.port, processFrame, onConnectionStateChange); // Init live camera web-socket connection
...
/******/ })()
;
//# sourceMappingURL=f76748cb591434668cf8.worker.js.map