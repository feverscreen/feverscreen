...
(() => {
"use strict";
/* harmony import */ var jsqr__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(616);
...
(async function run() {
  workerContext.addEventListener("message", async event => {
    ...
    const qr = jsqr__WEBPACK_IMPORTED_MODULE_0___default()(image.data, image.width, image.height);
