...
;// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"522a1eb3-vue-loader-template"}!./node_modules/@vue/vue-loader-v15/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ruleSet[0].rules[0].use[0]!./node_modules/@vue/vue-loader-v15/lib/index.js??vue-loader-options!./src/components/VideoStream.vue?vue&type=template&id=6a66e673&scoped=true&
var VideoStreamvue_type_template_id_6a66e673_scoped_true_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{ref:"container",class:{ recording: _vm.recording },attrs:{"id":"video-stream-container"}},[_c('canvas',{ref:"cameraStream",attrs:{"id":"camera-stream","width":"160","height":"120"}}),_c('canvas',{ref:"vizOverlay",attrs:{"id":"debug-overlay","width":"480","height":"540"}}),(_vm.canEditCropping && _vm.cropEnabled)?_c('video-crop-controls',{attrs:{"crop-box":_vm.cropBox},on:{"crop-changed":_vm.gotCropChange}}):_vm._e(),(_vm.cropEnabled)?_c('v-btn',{class:{ on: _vm.canEditCropping },attrs:{"text":"","title":"Edit cropping","id":"toggle-cropping","dark":""},on:{"click":_vm.toggleCropping}},[_c('v-icon',[_vm._v(_vm._s(_vm.cropIcon))])],1):_vm._e(),(_vm.showCoords)?_c('p',{staticClass:"coords"},[_vm._v("("+_vm._s(_vm.coords.x)+", "+_vm._s(_vm.coords.y)+")")]):_vm._e(),_c('p',[_vm._v(_vm._s(_vm.frameNum))])],1)}
var VideoStreamvue_type_template_id_6a66e673_scoped_true_staticRenderFns = []
...
var VideoStream_component = (0,componentNormalizer/* default */.Z)(
  ...
  VideoStreamvue_type_template_id_6a66e673_scoped_true_render,
  VideoStreamvue_type_template_id_6a66e673_scoped_true_staticRenderFns,
  false,
  null,
  "6a66e673",
  null
...
const DeviceApi = {
  ...
  registerQRID: window.localStorage.getItem("registerQRID") === "false" ? false : true,
  ...
  get debugPrefix() {
    if ((window.location.port === "8080" || window.location.port === "5000") && "production" === "development") {
      ...
      return "http://192.168.0.82"; //return "http://192.168.0.82";
...
var qr_scanner = __webpack_require__(4808);
...
let DeveloperUtilities = class DeveloperUtilities extends vue_property_decorator/* Vue */.w3 {
  ...
  async mounted() {
    ...
    this.enableQR = !(await qr_scanner/* default.hasCamera */.Z.hasCamera());
...
;// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"522a1eb3-vue-loader-template"}!./node_modules/@vue/vue-loader-v15/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ruleSet[0].rules[0].use[0]!./node_modules/@vue/vue-loader-v15/lib/index.js??vue-loader-options!./src/components/LoggingInterface.vue?vue&type=template&id=4f751577&scoped=true&
var LoggingInterfacevue_type_template_id_4f751577_scoped_true_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_c('pre',{ref:"logContainer",staticClass:"log-container"})])}
var LoggingInterfacevue_type_template_id_4f751577_scoped_true_staticRenderFns = []
...
var LoggingInterface_component = (0,componentNormalizer/* default */.Z)(
  ...
  LoggingInterfacevue_type_template_id_4f751577_scoped_true_render,
  LoggingInterfacevue_type_template_id_4f751577_scoped_true_staticRenderFns,
  false,
  null,
  "4f751577",
  null
...
(0,tslib_es6/* __decorate */.gn)([(0,vue_property_decorator/* Prop */.fI)({
  required: true
})], QRImage.prototype, "qrState", void 0);
...
var QRImage_component = (0,componentNormalizer/* default */.Z)(
  ...
  QRImagevue_type_template_id_4ee8b2bc_render,
  QRImagevue_type_template_id_4ee8b2bc_staticRenderFns,
  false,
  null,
  null,
  null
...
qr_scanner/* default.WORKER_PATH */.Z.WORKER_PATH = "../qr-scanner-worker.min.js";
let QRVideo = class QRVideo extends vue_property_decorator/* Vue */.w3 {
  ...
  runScan() {
    if (this.startScanning) {
      ...
      (_this$qrScanner = this.qrScanner) === null || _this$qrScanner === void 0 ? void 0 : _this$qrScanner.start();
    } else {
      this.streamLoaded = false;
      setTimeout(() => {
        var _this$qrScanner2;

        (_this$qrScanner2 = this.qrScanner) === null || _this$qrScanner2 === void 0 ? void 0 : _this$qrScanner2.stop();
      }, 500);
    }
  }
...
(0,tslib_es6/* __decorate */.gn)([(0,vue_property_decorator/* Prop */.fI)({
  required: true
})], QRVideo.prototype, "startScanning", void 0);

(0,tslib_es6/* __decorate */.gn)([(0,vue_property_decorator/* Watch */.RL)("startScanning")], QRVideo.prototype, "runScan", null);
...
function FrameHandler() {
  ...
  return {
    ...
    isObjectInFrame(frame) {
      const state = frame.analysisResult.nextState;
      return [ScreeningState.HEAD_LOCK, ScreeningState.LARGE_BODY, ScreeningState.FRONTAL_LOCK, ScreeningState.STABLE_LOCK, ScreeningState.MULTIPLE_HEADS, ScreeningState.MEASURED, ScreeningState.TOO_FAR].includes(state);
    },
...
let App = class App extends vue_property_decorator/* Vue */.w3 {
  constructor() {
    ...
    this.frameListener = new Worker(new URL(/* worker import */ __webpack_require__.p + __webpack_require__.u(352), __webpack_require__.b));
    this.showSoftwareVersionUpdatedPrompt = false;
    this.useLiveCamera = true;
    this.gotFirstFrame = false; // CPTV Player

    this.cptvStartFrame = 0;
    this.cptvEndFrame = 0;
    this.qrCode = null;
    this.startTimeInFrame = 0;
  ...
  get isWarmingUp() {
    return !this.skippedWarmup && this.timeOnInSeconds < WARMUP_TIME_SECONDS && this.timeOnInSeconds !== 0;
  }
    ...
    if (this.isWarmingUp) {
      ...
      if (prevScreeningState === ScreeningState.STABLE_LOCK && nextScreeningState === ScreeningState.MEASURED) {
        ...
        if (this.isReferenceDevice) {
          ...
          ScreeningApi.recordScreeningEvent(this.deviceID, this.piSerial, this.appState.currentScreeningEvent, this.appState.currentCalibration.thresholdMinFever, qr);
          this.qrCode = null;
        }
  ...
  async mounted() {
    ...
    if (this.useLiveCamera) {
      ...
      this.hostname = window.location.hostname === "localhost" ? (_network$Interfaces$f = (_network$Interfaces$f2 = network.Interfaces.find(val => val.Name === (this.isReferenceDevice ? "usb0" : "wlan0") && val.IPAddresses !== null)) === null || _network$Interfaces$f2 === void 0 ? void 0 : (_network$Interfaces$f3 = _network$Interfaces$f2.IPAddresses) === null || _network$Interfaces$f3 === void 0 ? void 0 : _network$Interfaces$f3[0].split("/")[0].replace(/\s/g, "")) !== null && _network$Interfaces$f !== void 0 ? _network$Interfaces$f : window.location.hostname : window.location.hostname;
    }
...
var VRangeSlider = __webpack_require__(6794);
...
/******/ 			return "js/" + chunkId + "." + {"352":"098d0f27","641":"f577683e"}[chunkId] + ".js";
/******/ 		};
/******/ 	})();
/******/ 	
