      ...
      const analysis = new Promise(resolve => {
        ...
        if (!(index <= 0)) {
          ...
          if (removedFrames.length > 1) {
            console.log("Could not keep up proccesing frames. Removing frames: ", removedFrames);
          }
        }
...
module.exports = __webpack_require__.p + "4f4c77e188565f88bf13.wasm";
...
/******/ })()
;
//# sourceMappingURL=352.de48c7a7.js.map