import * as wasm from './cptv_player_bg.wasm';

/**
* @param {number} size
*/
export function initBufferWithSize(size) {
...
* @param {number} offset
*/
export function insertChunkAtOffset(chunk, offset) {
...
* @returns {number}
*/
export function getFramesPerIframe() {
...
* @returns {boolean}
*/
export function queueFrame(number, callback) {
...
* @returns {boolean}
*/
export function getFrame(number, image_data) {
