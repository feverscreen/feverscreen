import TestHelper, {testFiles} from "./helpers";
...
type Result = {result: AnalysisResult[], totalFramesToMeasure: number, totalSecondsToMeasure: number, scannedResult: number}
